...
if temp_dir == file_dir:
    pickle_dir = os.path.join('gp_samples', 'interp_1d_matern52')
else:
    pickle_dir = os.path.join('..', 'gp_samples', 'interp_1d_matern52')
...
design_dim = 1
x_bound= [[1.0], [0.0]] #limits on design dimensions. (support of the input dimension)
y_bound= [[1.0, 1.0], [-1, -1]] #support of the output dimension
